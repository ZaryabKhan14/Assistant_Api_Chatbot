...
if file is not None:
    ...
    if st.button("Submit Query"):
        ...
        run = client.beta.threads.runs.create(
            ...
            instructions="you are a helpful assistant if user ask you a normal question then give normal answer if user ask according to file then give answer from file",
        )
